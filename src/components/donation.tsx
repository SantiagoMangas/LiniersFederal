...
import { Heart, Copy, Check, Building2, Users } from "lucide-react"
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="rounded-xl bg-background border-2 border-border p-10 transition-all hover:border-black hover:shadow-lg">
            ...
            <p className="text-center text-sm text-muted-foreground mb-6">
              Transferí directamente sin comisiones
            </p>
            ...
            <div className="mb-6 space-y-3">
              <div className="bg-secondary/50 rounded-lg p-4 border-2 border-dashed border-border">
                ...
                <div className="flex items-center justify-center gap-2">
                  <code className="text-lg font-bold text-black tracking-wide">
                    {alias}
                  </code>
                </div>
              </div>
              ...
              <button
                onClick={handleCopy}
                className="w-full flex items-center justify-center gap-2 bg-black text-white hover:bg-black/90 font-semibold py-3 px-4 rounded-lg transition-all duration-300 group"
              >
                {copied ? (
                  <>
            ...
            <div className="bg-secondary/30 rounded-lg p-4 mb-6">
              <p className="text-xs font-semibold text-black mb-2 text-center">
                ¿Cómo transferir?
              </p>
              <ol className="text-xs text-muted-foreground space-y-1.5 list-decimal list-inside">
                <li>Abrí tu app de banco o Mercado Pago</li>
                <li>Elegí "Transferir" o "Enviar dinero"</li>
                <li>Pegá el alias copiado</li>
          ...
          <div className="bg-background rounded-xl border-2 border-border p-10 transition-all hover:shadow-lg hover:border-black">
            ...
            <div className="mb-8 space-y-4">
              ...
              >
                ...
                <p className="text-2xl font-black text-black group-hover:text-white">$75.000</p>
