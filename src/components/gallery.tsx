...
const galleryData: GalleryData = {
  ...
  noticias:[
    ...
    {url: 'noticias/noticiasImportantes(1).png', alt: 'Noticia Importante' },
    ...
    { url: 'noticias/noticiasImportantes(2).png', alt: 'Noticia Importante 2' },
    ...
    { url: 'noticias/noticiasImportantes(3).png', alt: 'Noticia Importante 3' },
    ...
    { url: 'noticias/noticiasImportantes(4).png', alt: 'Noticia Importante 4' },
